...
int main()
{
    ...
    // -------------------------
    Shader shader("../review/Advanced_lighting/Point_Shadows/3.2.1.point_shadows.vs","../review/Advanced_lighting/Point_Shadows/3.2.1.point_shadows.fs");
    Shader simpleDepthShader("../review/Advanced_lighting/Point_Shadows/3.2.1.point_shadows_depth.vs",
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // input
        // -----
        processInput(window,camera,0.005);
