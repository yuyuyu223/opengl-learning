...
int main()
{
    ...
    /* 着色器配置 */
    ///////////////////////////////////////////////////////////////////////////////////
    Shader *shader = new Shader("../review/Advanced_lighting/Parallax_Mapping/parallax_mapping.vs", "../review/Advanced_lighting/Parallax_Mapping/parallax_mapping.frag");
    ///////////////////////////////////////////////////////////////////////////////////

    // 木地板纹理
    Texture *diffuseMap = new Texture("../texture/bricks2.jpg", GL_TEXTURE0);
    Texture *normalMap = new Texture("../texture/bricks2_normal.jpg", GL_TEXTURE1);
    Texture *heightMap = new Texture("../texture/bricks2_disp.jpg", GL_TEXTURE2);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 projection = glm::perspective(camera->get_fov(), (GLfloat)screenWidth / (GLfloat)screenHeight, 0.1f, 100.0f);
