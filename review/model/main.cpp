/*
 * @Author: HowsenFisher
 * @Date: 2021-08-02 13:38:57
 * @LastEditors: HowsenFisher
 * @LastEditTime: 2021-08-14 11:09:28
 * @Description: 
 */
...
int main()
{
    ...
    // -------------------------
    Shader *ourShader = new Shader("../review/model/1.model_loading.vs", "../review/model/1.model_loading.fs");

    // load models
    // -----------
    Model ourModel(std::string("../Model/nanosuit/nanosuit.obj").c_str(),false);
