 ...
 * @LastEditTime: 2021-07-31 19:25:12
...
int main()
{
    ...
    // 定义并编译着色器
    // ------------------------------------
    Shader *lightingShader = new Shader("../review/light/flash_light/1.colors.vs", "../review/light/flash_light/1.colors.fs");
    Shader *lightCubeShader = new Shader("../review/light/flash_light/1.colorslight_cube.vs", "../review/light/flash_light/1.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader->setVec3("light.position", camera->get_camera_pos());
        lightingShader->setVec3("light.direction", camera->get_front_vec());
