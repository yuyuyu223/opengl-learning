 ...
 * @LastEditTime: 2021-07-31 17:32:05
...
int main()
{
    ...
    // 定义并编译着色器
    // ------------------------------------
    Shader *lightingShader = new Shader("../review/light/basic_light/1.colors.vs", "../review/light/basic_light/1.colors.fs");
    Shader *lightCubeShader = new Shader("../review/light/basic_light/1.colorslight_cube.vs", "../review/light/basic_light/1.light_cube.fs");
